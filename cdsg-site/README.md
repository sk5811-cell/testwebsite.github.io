...
| --- | --- | --- |
| `--columbia` | `#9FCBE8` | primary accent, Columbia blue |
| `--mint` | `#45E0B4` | "good data" / open / highlight state |
| `--violet` | `#A78BFA` | tertiary accent |
| `--amber` | `#FFC46B` | honesty notes, "illustrative" badges, Bronx on the map |
| `--danger` | `#FF6B6B` | dirty records, form errors |
| `--bg` | `#04060b` | page background |
